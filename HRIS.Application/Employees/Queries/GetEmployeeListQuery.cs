...
{
    public record GetEmployeeListQuery : IRequest<List<EmployeeViewModel>>
    {
        public int PageNumber { get; set; } = 1;
        public int PageSize { get; set; } = 10;
    }

    public class GetEmployeeListQueryHandler : IRequestHandler<GetEmployeeListQuery, List<EmployeeViewModel>>
    {
        private readonly IEmployeeRepository _employeeRepository;
        private readonly ILogger<GetEmployeeListQueryHandler> _logger;

        public GetEmployeeListQueryHandler(IEmployeeRepository employeeRepository, ILogger<GetEmployeeListQueryHandler> logger)
        {
